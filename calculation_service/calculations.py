...
class CalculationEngine:
    ...
    def __init__(self):
        self.calculation_types = {
            ...
            "fire_safety": {
                ...
                "description": "Расчеты пожарной безопасности согласно 123-ФЗ, ГОСТ 12.1.004-91",
            ...
            "uav_protection": {
                "name": "Защита от БПЛА",
                "description": "Расчеты защиты от воздействия беспилотных летательных аппаратов согласно СП 542.1325800.2024",
        ...
        schemas = {
            ...
            "fire_safety": {
                ...
                "properties": {
                    ...
                    "normative_document": {"type": "string", "title": "Нормативный документ", "default": "123-ФЗ"}
                },
            ...
            "uav_protection": {
                ...
                "properties": {
                    ...
                    "normative_document": {"type": "string", "title": "Нормативный документ", "default": "СП 542.1325800.2024"}
                },
    ...
    def _get_category_description(self, category: str) -> str:
        ...
        descriptions = {
            ...
            "smoke_ventilation": "Расчет противодымной вентиляции (НПБ 250-97)",
            ...
            "evacuation": "Расчет эвакуационных путей и выходов (123-ФЗ)",
            "fire_suppression": "Расчет систем пожаротушения (НПБ 88-2001)",
            "smoke_control": "Расчет противодымной защиты (НПБ 250-97)",
            "fire_resistance": "Расчет огнестойкости конструкций (ГОСТ 30247.1-94)",
            "emergency_systems": "Расчет аварийных систем безопасности (123-ФЗ)",
    ...
    def _execute_uav_protection_calculation(self, parameters: Dict[str, Any]) -> Dict[str, Any]:
        """Выполнение расчетов защиты от БПЛА согласно СП 542.1325800.2024"""
        try:
